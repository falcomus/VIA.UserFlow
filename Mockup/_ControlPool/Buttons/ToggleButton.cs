// ======================================================================================
// FILE: Mockup.Controls/ToggleButton.cs
//
// PURPOSE:
...
[ControlType(displayName: "Toggle Button", group: "Buttons")]
public partial class ToggleButton : DesignControl
{
    #region === APPEARANCE ===
    ...
    public ToggleButton()
    {
        ...
        OffImage = new ImageRef("x", ImageFormat.Svg);
        OnImage = new ImageRef("check", ImageFormat.Svg);
