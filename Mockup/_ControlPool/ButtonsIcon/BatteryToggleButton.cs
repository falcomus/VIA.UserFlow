// ======================================================================================
// FILE: Mockup.Controls/BatteryToggleButton.cs
//
// PURPOSE:
...
#region === BATTERY TOGGLE BUTTON ===

[ControlType(displayName: "Battery Toggle Button", group: "Icon Buttons")]
public partial class BatteryToggleButton : DesignControl
{
    #region === APPEARANCE ===
    ...
    [property: System.ComponentModel.DisplayName("On Image")]
    private ImageRef? onImage;

    [ObservableProperty]
    [property: ControlProp]
    [property: System.ComponentModel.Category("Icon")]
    [property: System.ComponentModel.DisplayName("Off Image")]
    private ImageRef? offImage;

    [ObservableProperty]
    [property: ControlProp]
    [property: System.ComponentModel.Category("Icon")]
    [property: System.ComponentModel.DisplayName("On Image Color")]
    private Color onImageColor = Theme.Text;

    [ObservableProperty]
    [property: ControlProp]
    [property: System.ComponentModel.Category("Icon")]
    [property: System.ComponentModel.DisplayName("Off Image Color")]
    private Color offImageColor = Theme.Text.Lighten(0.20f);
    ...
    {
        iconSize = Math.Clamp(value, 6f, 20f);
    }
    ...
    public BatteryToggleButton()
    {
        IsActionControl = true;

        Name = "BatteryToggleButton";
        ...
        OffImage = new ImageRef("battery-warning-vertical", ImageFormat.Svg);
        OnImage = new ImageRef("battery-plus-vertical", ImageFormat.Svg);

        OffImageColor = Colors.Red;
        OnImageColor = Colors.Green;
    }
    ...
    private void DrawCurrentImage(SKCanvas canvas, SKRect layout)
    {
        ...
        ImageRef? image = IsOn ? OnImage : OffImage;
        Color imageColor = IsOn ? OnImageColor : OffImageColor;

        if (image == null || string.IsNullOrWhiteSpace(image.Id))
            return;

        float safePadding = Math.Clamp(InnerPadding, 1f, 12f);
        float safeSize = Math.Clamp(
            IconSize,
            6f,
            Math.Min(layout.Width, layout.Height) - safePadding * 2f
        );
