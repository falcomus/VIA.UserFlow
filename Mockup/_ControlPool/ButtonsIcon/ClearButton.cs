// ======================================================================================
// FILE: Mockup.Controls/ClearButton.cs
//
// PURPOSE:
...
[ControlType(displayName: "Clear Button", group: "Icon Buttons")]
public partial class ClearButton : DesignControl
{
    #region === APPEARANCE ===
    ...
    private Color imageColor = Colors.Red;
    ...
    public ClearButton()
    {
        ...
        image = new ImageRef("x", ImageFormat.Svg);
