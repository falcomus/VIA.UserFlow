// ======================================================================================
// FILE: Mockup.Controls/EditButton.cs
//
// PURPOSE:
...
[ControlType(displayName: "Edit Button", group: "Icon Buttons")]
public partial class EditButton : DesignControl
{
    #region === APPEARANCE ===
    ...
    public EditButton()
    {
        ...
        image = new ImageRef("pencil-simple", ImageFormat.Svg);
