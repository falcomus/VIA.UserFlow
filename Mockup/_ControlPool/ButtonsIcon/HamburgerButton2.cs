// ======================================================================================
// FILE: Mockup.Controls/HamburgerButton2.cs
//
// PURPOSE:
...
[ControlType(displayName: "Animated Menu Button", group: "Icon Buttons")]
public partial class HamburgerButton2 : DesignControl
{
    #region === APPEARANCE ===
    ...
    public HamburgerButton2()
    {
        IsActionControl = true;

        Name = "HamburgerButton2";
    ...
    private void DrawIcon(SKCanvas canvas, SKRect layout)
    {
        ...
        float halfWidth = contentSize * 0.42f;
        float spacing = contentSize * 0.24f;

        using var restore = new SKAutoCanvasRestore(canvas, true);

        if (IsOn)
            canvas.RotateDegrees(18f, centerX, centerY);
