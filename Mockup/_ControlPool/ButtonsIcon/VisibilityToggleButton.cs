// ======================================================================================
// FILE: Mockup.Controls/VisibilityToggleButton.cs
//
// PURPOSE:
...
#region === VISIBILITY TOGGLE BUTTON ===

[ControlType(displayName: "Visibility Toggle Button", group: "Icon Buttons")]
public partial class VisibilityToggleButton : DesignControl
{
    #region === APPEARANCE ===
    ...
    public VisibilityToggleButton()
    {
        ...
        OffImage = new ImageRef("eye-slash", ImageFormat.Svg);
        OnImage = new ImageRef("eye", ImageFormat.Svg);
